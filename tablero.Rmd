...
### porcentaje  {.value-box}
```{r}
valueBox (value = paste(length(CarreraLuz22F$timerun), "Mujeres"), 
         caption = "Numero de mujeres", 
         icon = "  ", 
         color = "#0EB0C6")
```
### porcentaje  {.value-box}
```{r}
valueBox (value = paste((length(CarreraLuz22F$timerun) - 1922)*-1, "Hombres"), 
         caption = "Numero de Hombres", 
         icon = "  ", 
         color = "#0EB0C6")
```
